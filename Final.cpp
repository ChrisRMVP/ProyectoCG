...
/* ----------------  Práctica  7   -----------*/
/*-----------------    2022-2   ---------------------------*/
/*------------- Alumno: Garcia Velazquez Christopher ---------------*/
/*------------- No. Cuenta 315313635 ---------------*/
#include <Windows.h>
...
void animate(void)
{
	lightPosition.x = 200.0f * cos(MyVariable);
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		staticShader.setVec3("dirLight.ambient", glm::vec3(0.1f, 0.1f, 0.1f)); //caras menos iluminadas
		...
		staticShader.setVec3("pointLight[0].ambient", glm::vec3(0.4f, 0.8f, 0.4f));
		staticShader.setVec3("pointLight[0].diffuse", glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setVec3("pointLight[0].specular", glm::vec3(0.0f, 0.0f, 0.0f));
		staticShader.setFloat("pointLight[0].constant", 0.08f); //atenuacion de la luz de foquito controlan la intensidad (mayor control) 
		staticShader.setFloat("pointLight[0].linear", 0.09f);  //intensidad (menos control)
		staticShader.setFloat("pointLight[0].quadratic", 0.00032f); //mayor distancia mientas mas pequeño la atenuacion es menor 

		staticShader.setVec3("pointLight[1].position", glm::vec3(-80.0, 0.0f, 0.0f));
		staticShader.setVec3("pointLight[1].ambient", glm::vec3(0.8f, 0.0f, 0.0f));
